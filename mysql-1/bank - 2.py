...
class Bank():
    ...
    def register(self):
        ...
        bankconnect.add_user(name, age, password, self.get_new_acct_no())
    ...
    def login(self):
        ...
        data = bankconnect.fetch_user_details(name_input)
        print(data)
    ...
    def deposit(self, amount, name = "self"):
        ...
        original_balance = bankconnect.get_balance(target_name)[0]['balance']
        bal = int(original_balance) + amount

        bankconnect.alter_balance(target_name,bal)
    ...
    def withdraw(self, amount, name ="self"):
        ...
        new_balance = bankconnect.get_balance(target_name)[0]['balance']
        bal = int(new_balance) - amount

        bankconnect.new_balance(target_name,bal)
    ...
    def transfer(amount, name="self"):

        
        self.withdraw(amount, name="self")

        self.deposit(amount, name="self" )
        bankconnect.transfer
